    ...
    <section class="bg-gray-50 dark:bg-gray-800">
        <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
            <div class="mb-8 max-w-screen-md lg:mb-16">
                <h2 class="mb-4 text-4xl font-extrabold text-[#B8D667] dark:text-white"> Key offerings of CarbonCure Solutions </h2>
            ...
            <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
                <div>
                    <div class="flex text-[#5FCDD6]  justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                    ...
                    <h3 class="mb-2 text-xl font-bold text-[#B8D667] dark:text-white">CO2 Capture Technology</h3>
                    <p class="text-gray-500 dark:text-gray-400">
                        Capturing CO2 emissions from industrial processes and repurposing them into sustainable materials
                    </p>
                </div>
                <div>
                    <div class="flex  text-[#5FCDD6]  justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                    ...
                    <h3 class="mb-2 text-xl font-bold text-[#B8D667] dark:text-white">CO2 Utilization in Construction</h3>
                    <p class="text-gray-500 dark:text-gray-400">
                        Turning captured CO2 into stronger, durable construction materials such as bricks and concrete.
                                        </p>
                </div>
                <div>
                    <div class="flex  text-[#5FCDD6]  justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                    ...
                    <h3 class="mb-2 text-xl font-bold text-[#B8D667] dark:text-white">Energy Efficiency Solutions</h3>
                    <p class="text-gray-500 dark:text-gray-400">
                        Optimizing energy usage in industries to reduce waste and production costs while promoting sustainability
                                        </p>
                </div>
                <div>
                    <div class="flex text-[#5FCDD6]  justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                    ...
                    <h3 class="mb-2 text-xl font-bold text-[#B8D667] dark:text-white">Ocean Acidification Reduction</h3>
                    <p class="text-gray-500 dark:text-gray-400">
                        Mitigating CO2 emissions to protect marine ecosystems and reduce ocean acidification.
                    </p>
                </div>
                <div>
                    <div class="flex justify-center text-[#5FCDD6] items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                    ...
                    <h3 class="mb-2 text-xl font-bold text-[#B8D667] dark:text-white">Eco-Friendly Construction Materials</h3>
                    <p class="text-gray-500 dark:text-gray-400">
                        Providing cost-effective, environmentally friendly bricks and concrete that reduce the carbon footprint of construction.
                    </p>
                </div>
