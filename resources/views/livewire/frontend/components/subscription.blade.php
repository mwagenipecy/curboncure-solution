        ...
        <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
          ...
          <div class="mx-auto max-w-2xl mb-8 lg:mb-14 text-center">
            <h2 class="text-3xl lg:text-2xl text-gray-800 font-bold dark:text-neutral-200">
                Choose a subscription plan that aligns with your sustainability goals and start transforming carbon emissions into eco-friendly solutions today.        </h2>
          </div>
          <!-- End Title -->
          <div class="relative xl:w-10/12 xl:mx-auto">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8">
              <div>
                <!-- Card -->
                <div class="p-4 relative z-10 bg-white border-[#B8D667]  border-1  rounded-xl md:p-10 dark:bg-neutral-900 dark:border-neutral-800">
              ...
              <div>
                <!-- Card -->
                <div class="shadow-xl shadow-gray-200 p-5 relative z-10 bg-white border-[#B8D667] border-1  rounded-xl md:p-10 dark:bg-neutral-900 dark:border-neutral-800 dark:shadow-gray-900/20">
                  ...
                  <div class="mt-5 grid grid-cols-2 gap-x-4 py-4 first:pt-0 last:pb-0">
                    ...
                    <div class="flex justify-end">
                      <button type="button" class="py-3 px-4 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-[#B8D667] text-white hover:bg-blue-700 focus:outline-none focus:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none">Start free trial</button>
                    </div>
                  </div>
                </div>
                <!-- End Card -->
